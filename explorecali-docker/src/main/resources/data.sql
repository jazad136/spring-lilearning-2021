...
insert into tour  (tour_package_code, title, description, blurb, bullets, difficulty, duration, price, region, keywords) values
  ...
  -- password for this example maps to the string 'letmein'
  ...
  -- should be able to add new customer service representative users. 
  insert into security_role (id, role_name, description) values (2, 'ROLE_CSR', 'Customer Service Representative');
  -- records the feedback, given by travelers.
  
  -- to start we will associate roles to users, then later roles to services
