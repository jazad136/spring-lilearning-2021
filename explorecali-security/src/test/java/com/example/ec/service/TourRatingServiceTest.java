 ...
 * 
 * Note These tests test just the methods of the Java classes as units all to themselves!
 * 
 * TourRepository, TourRatingRepository, Tour, and TourRating are mocks. 
 * TourRatingService will have some mocks injected into it, but it itself is not a mock. 
 */
//@SpringJUnitConfig
